...
public class KonfirmasiChild extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_konfirmasi_child);TextView back = (TextView) findViewById(R.id.back);
        loading = ProgressDialog.show(KonfirmasiChild.this, null, "Sedang Memuat...", true, false);

        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                KonfirmasiChild.super.onBackPressed();
            }
        });
    ...
    public void  getListJadwal(){
        ...
        retrofit2.Call<Response_Jadwal> call = RetrofitClient.getInstance().getApi().getkonfirmasiChild(token, klienId);
        call.enqueue(new Callback<Response_Jadwal>() {
            ...
            public void onResponse(retrofit2.Call<Response_Jadwal> call, Response<Response_Jadwal> response) {
                ...
                adapter = new JadwalAdapter(KonfirmasiChild.this, modelJadwalList);//, statusModel);
