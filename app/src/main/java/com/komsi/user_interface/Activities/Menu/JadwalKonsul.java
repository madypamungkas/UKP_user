...
public class JadwalKonsul extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jadwal_konsul);
        TextView back = (TextView) findViewById(R.id.back);
        loading = ProgressDialog.show(JadwalKonsul.this,
                null, "Sedang Memuat...", true, false);

        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(JadwalKonsul.this, MainActivity.class);
        ...
        notif_jadwalKonsul.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent notif = new Intent(JadwalKonsul.this, JadwalChild.class);
                startActivity(notif);
            }
        });
    ...
    public void  getListJadwal(){
        ...
        retrofit2.Call<Response_Jadwal> call = RetrofitClient.getInstance().getApi().getJadwalResponse(token, klienId);
        call.enqueue(new Callback<Response_Jadwal>() {
            ...
            public void onResponse(retrofit2.Call<Response_Jadwal> call, Response<Response_Jadwal> response) {
                ...
                adapter = new JadwalAdapter(JadwalKonsul.this, modelJadwalList);//, statusModel);
